...
skWindowInject::~skWindowInject()
{
}

void skWindowInject::create(const char* title, SKuint32 w, SKuint32 h, SKuint32 flags)
{
}

void skWindowInject::refresh(void)
{
}

void skWindowInject::show(bool v)
{
}
